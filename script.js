...
const replaceVal=(tempVal,orgVal)=>{
 ...
 var temperature = temperature.replace("{%tempstatus%}",orgVal.weather[0].main)
...
const server = http.createServer((req,res)=>{
    if(req.url="/"){
  requests('https://api.openweathermap.org/data/2.5/weather?q=Ayodhya&appid=e513761e8f4a658b663dd138499aa0ba&units=metric')
  .on('data',   (chunk) =>{
